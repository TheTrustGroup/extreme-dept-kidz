      ...
      <div className={cn("flex flex-col lg:flex-row gap-0 lg:gap-6", className)}>
          ...
          >
            ...
            {images.length > 1 && (
              <m.div
                ...
                className="absolute bottom-4 left-4 px-3 py-1.5 bg-white/90 dark:bg-charcoal-900/80 backdrop-blur-sm text-charcoal-700 dark:text-cream-50 rounded-full text-compact-sm leading-compact-tight font-medium border border-cream-200/80 dark:border-transparent"
            ...
            {/* Mobile swipe hint for multi-image products */}
            {images.length > 1 && (
              <div className="absolute bottom-4 right-4 lg:hidden px-3 py-1.5 bg-white/90 dark:bg-charcoal-900/80 backdrop-blur-sm text-charcoal-700 dark:text-cream-50 rounded-full text-compact-sm leading-compact-tight font-medium border border-cream-200/80 dark:border-transparent">
                Swipe photos
              </div>
            )}
          </m.div>
        ...
        {images.length > 1 && (
          <div className="w-full lg:w-auto lg:flex-shrink-0">
            ...
            <div 
              className="flex lg:flex-col gap-2 xs:gap-2.5 sm:gap-3 lg:gap-4 overflow-x-auto lg:overflow-x-visible lg:overflow-y-auto lg:max-h-[600px] scrollbar-hide pb-1 lg:pb-0 px-1 lg:px-0"
