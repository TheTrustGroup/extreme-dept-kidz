...
interface CheckoutOrderSummaryLegacyProps {
...
/**
 * Order summary sidebar used by CheckoutFormV2 / CheckoutPageClient.
 */
export function CheckoutOrderSummaryLegacy({
  shippingMethod = "standard",
  className,
}: CheckoutOrderSummaryLegacyProps) {
