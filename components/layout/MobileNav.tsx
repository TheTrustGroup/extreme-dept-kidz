        ...
        <>
          ...
          >
            <div className="flex flex-col h-full">
              ...
              {/* Social — compact row near top so drawer isn't overly long */}
              <div className={cn(
                "px-[var(--space-4)] sm:px-[var(--space-5)] py-[var(--space-2)] border-b transition-colors duration-300 flex-shrink-0",
                theme === "dark"
                  ? "border-dark-border-glass"
                  : "border-cream-200"
              )}>
              ...
              {/* Navigation Links — scrollable, max height so drawer length is bounded */}
              <nav className="flex-1 min-h-0 overflow-y-auto px-[var(--space-4)] sm:px-[var(--space-5)] py-[var(--space-4)] max-h-[50vh]">
