-- ============================================
-- COMPLETE ADMIN RESET - FIXED VERSION
-- ============================================
-- This script includes displayName column that exists in your database
...
-- Step 2: Create fresh admin user (with displayName)
