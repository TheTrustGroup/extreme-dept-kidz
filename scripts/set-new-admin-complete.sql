-- ============================================
-- COMPREHENSIVE ADMIN USER RESET
-- Sets new admin credentials: Admin@extremedeptkidz.com / VisionaryIntro
-- ============================================
...
-- Email: Admin@extremedeptkidz.com (exact case as specified)
-- Password: VisionaryIntro
-- Password Hash: $2b$12$YicRzPsg/PmcXaEmCPHCP.65fntxG.MGLfVXdv5Vi.RvkWNK6syiG
